...
const SpendingAnalysis: React.FC = () => {
  return (
    <section className="lg:col-span-2 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col justify-between h-full space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2 flex-1 items-end">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center p-2.5 bg-slate-50 rounded-xl border border-slate-100 text-xs">
              <div className="flex items-center gap-2">
                <span className="h-6 w-6 bg-amber-50 text-amber-600 border border-amber-100 rounded-md flex items-center justify-center font-bold text-[11px]">
                  W
                </span>
            ...
            <div className="flex justify-between items-center p-2.5 bg-slate-50 rounded-xl border border-slate-100 text-xs">
              <div className="flex items-center gap-2">
                <span className="h-6 w-6 bg-indigo-50 text-indigo-600 border border-indigo-100 rounded-md flex items-center justify-center font-bold text-[11px]">
                  A
                </span>
